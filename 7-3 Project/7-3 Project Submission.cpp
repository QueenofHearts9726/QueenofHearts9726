//Jordan T. Gensler
//August 18, 2024
//Allow user to track the frequency of items from an input file. The program presents a menu with options to look up frequency item, print a list of item frequencies, print a histogram of item frequencies, and exit the program. The frequency of items is stored in a map within the ItemTracker class.
